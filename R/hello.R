...
#'
#' @param location The name of the place you want to map
...
street_map <- function(location,
                       color = c(river = "steelblue",
                                  railway = "black",
                                  highway = "black",
                                  main_street = "black",
                                  small_street = "darkgray",
                                  background = "white"),
                       size = c(river = 1.2,
                                 railway = 0.5,
                                 highway = .7,
  ...
  g = ggplot() +
    ...
    theme_void() +
    theme(plot.title = element_text(family = "lato", size = text_size["title"], face = "bold", hjust = 0.5),
          plot.subtitle = element_text(family = "lato", size = text_size["subtitle"], hjust = 0.5, margin = margin(2, 0, 5, 0)),
